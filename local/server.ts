...
createServer(async (req, res) => {
  ...
  try {
    ...
    if(url.pathname==='/api/backgrounds'&&req.method==='GET')return json(['public-blue','public-green','public-orange','public-sunshine','public-hearts','public-pop-geometry','public-paper-pastel','public-memphis','public-soft-3d','public-aurora','public-sunset','public-midnight','public-fresh-mint',...[1,2,3,4,5,6].map(n=>'bg_'+n)].filter(id=>existsSync(resolve(root,'backgrounds',id+'.png'))));
