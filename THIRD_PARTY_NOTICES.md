...
PptxGenJS 4.0.1 (Brent Ely, MIT) is included under vendor/pptxgenjs with its original license. Runtime files are unchanged; the unused vulnerable image-size dependency is removed from the local manifest. See vendor/pptxgenjs/UPSTREAM.md for provenance and maintenance details.
