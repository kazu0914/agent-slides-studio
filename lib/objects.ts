...
export const objectSchema=z.object({
 ...
 chartType:z.enum(['bar','line','pie']).default('bar'),motion:z.enum(['holo-cards','holo-chart','holo-network','holo-flow','holo-grid','holo-document','holo-shield','holo-cloud','holo-compare','holo-timeline','orbit','arrow','cube','globe','rings','helix','crystal','wave','particles','pulse','bars']).default('cube'),duration:z.number().min(2).max(120).default(16)
