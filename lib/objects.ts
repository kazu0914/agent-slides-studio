...
export const objectSchema=z.object({
 ...
 chartType:z.enum(['bar','line','pie']).default('bar'),motion:z.enum(['orbit','arrow','cube','globe','rings','helix','crystal','wave','particles','pulse','bars']).default('cube'),duration:z.number().min(2).max(120).default(16)
